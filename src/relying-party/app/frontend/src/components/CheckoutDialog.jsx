                    ...
                    <>
                        ...
                        <div className="space-y-4 my-2">
                            <FormField label="Email (optional)">
                                <Input type="email" placeholder="john@example.com" value={fields.email} onChange={e => setFields(f => ({ ...f, email: e.target.value }))} className="bg-white" />
                            </FormField>
                            <FormField label="Delivery Address (optional)">
                                <Input placeholder="123 Spice Lane" value={fields.address} onChange={e => setFields(f => ({ ...f, address: e.target.value }))} className="bg-white" />
                            </FormField>
                        </div>
